from seg.backbone import ResNetBackbone, VGGBackbone, ResNetBackboneGN, DarkNetBackbone
...
#SEG_MEANS_3CH = (103.94, 116.78, 123.68)
#SEG_STDS_3CH = (57.38, 57.12, 58.40)

#SEG_MEANS_4CH = (103.94, 116.78, 123.68, 450.0)
#SEG_STDS_4CH = (1.0, 1.0, 1.0, 1.0)
...
#json_path = "/home/nvidia/JetsonMan/resource/Artis_AI/checkpoints/db_class_info_seg.json"
json_path = "./checkpoints/db_class_info_seg.json"
...
if os.path.exists(json_path):
    ...
    for one_dict in json_data['Class']:
        for key, value in one_dict.items():
            COCO_CLASSES.add(value)
            COCO_LABEL_MAP[int(key)] = int(value)
