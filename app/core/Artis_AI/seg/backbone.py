...
class ResNetBackbone(nn.Module):
    ...
    def __init__(self, layers, dcn_layers=[0, 0, 0, 0], dcn_interval=1, atrous_layers=[], block=Bottleneck, norm_layer=nn.BatchNorm2d, in_channels=3):
        ...
        print(f"=====> (ResNetBackbone) in_channels = {in_channels}")
...
def construct_backbone(cfg):
    ...
    #print(f"==========> call backbone")
    #print(f"==========> cfg.name = {cfg.name}")
    #print(f"==========> cfg.selected_layers = {cfg.selected_layers}")
    #print(f"==========> cfg.in_channels = {cfg.in_channels}")
    #print(f"==========> cfg.args = {cfg.args}")
    #backbone = cfg.type(*cfg.args)
    backbone = cfg.type(*cfg.args, in_channels=cfg.in_channels)     # modify this line for depth model by MSP
    # MSP : debug
    #print(f"=====> backbone = {backbone}")
    #print(f"=====> [construct_backbone] *cfg.args = {cfg.type(*cfg.args)}")
