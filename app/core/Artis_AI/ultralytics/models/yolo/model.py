...
from ultralytics.nn.tasks import ClassificationModel, DetectionModel, OBBModel, PoseModel, SegmentationModel, \
     SegmentationModel_RGBD, YOLOEModel, YOLOESegModel
...
class YOLO(Model):
    ...
    def __init__(self, model="yolo11n.pt", task=None, verbose=False, channels=3):
        ...
        if "yoloe" in path.stem and path.suffix in {".pt", ".yaml", ".yml"}:
            ...
            super().__init__(model=model, task=task, verbose=verbose, channels=self.channels)
    ...
    def task_map(self):
        ...
        print(f"[Artis_AI][task_map] Load Segmentation Model, Channels : {self.channels}")
        return load_model_structure
