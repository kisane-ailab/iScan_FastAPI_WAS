...
class DetectionModel(BaseModel):
    ...
    def init_criterion(self):
        ...
        if 'object_bce' in self.args.data:
            return E2EDetectLoss(self) if getattr(self, "end2end", False) else v8DetectionLoss_Object(self)
        else:
...
class SegmentationModel_RGBD(DetectionModel):
    """
    YOLO Segmentation model with rgb-d data
    Model's structures are same with 'class Segmentation'
    This class is adapt to rgb + depth data
    """
